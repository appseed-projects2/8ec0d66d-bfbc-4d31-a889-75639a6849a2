...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-28 16:37`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8ec0d66d-bfbc-4d31-a889-75639a6849a2.git
$ cd 8ec0d66d-bfbc-4d31-a889-75639a6849a2
```
